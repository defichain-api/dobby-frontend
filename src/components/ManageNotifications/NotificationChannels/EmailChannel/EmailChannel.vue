<template>
	<q-item :clickable="!channelActive" @click="$refs['options'].$el.click()">
		...
		<q-item-section side top>
			...
			<ChannelOptionsMenu v-else icon="fa-light fa-envelope" icon-color="green">
				<TestChannel
...
import EmailChannelSetup from 'components/ManageNotifications/NotificationChannels/EmailChannel/EmailChannelSetup.vue'
